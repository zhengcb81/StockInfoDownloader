...
class TestMultiCompanyIntegration:
    ...
    def test_end_to_end_workflow_mocked(self, mocker):
        ...
        test_config = {
            "companies": [
                {"stock_code": "300470", "company_name": "中密控股", "enabled": True}
            ],
            "parallel_download": {"enabled": False, "max_workers": 1},
        }

        # Mock dependencies
        mocker.patch(
            "src.data.mapping.MappingManager.get_org_id", return_value="9900012345"
        )
