...
class TestExpectedDataValidator:
    ...
    def test_compare_directories_identical(self):
        ...
        result = self.validator.compare_directories(
    ...
    def test_validate_expected_data_success(self):
        ...
        result = self.validator.validate_expected_data(
            self.expected_dir, self.actual_dir
        )
    ...
    def test_validate_expected_data_missing_actual_dir(self):
        ...
        result = self.validator.validate_expected_data(
            self.expected_dir, nonexistent_dir
        )
    ...
    def test_validate_single_test_case_success(self):
        ...
        expected_file = (
            expected_company_dir / f"中密控股：{stock_code}2025年一季度报告.pdf"
        )
    ...
    def test_validate_single_test_case_missing_stock_code(self):
        """测试缺少股票代码的测试用例"""
        test_case = {"suffix": "research", "allowed_keywords": ["一季度报告"]}
    ...
    def test_validate_single_test_case_no_expected_data(self):
        """测试没有对应期待数据的测试用例"""
        test_case = {"stock_code": "999999", "suffix": "research"}  # 不存在的股票代码
...
class TestConvenienceFunctions:
    ...
    def test_validate_expected_vs_actual(self):
        ...
        result = validate_expected_vs_actual(
            str(self.expected_dir), str(self.actual_dir), "strict"
        )
    ...
    def test_validate_test_case(self):
        ...
        test_case = {"stock_code": stock_code, "suffix": "research"}

        result = validate_test_case(
            test_case, str(self.expected_dir), str(self.actual_dir), "strict"
        )
