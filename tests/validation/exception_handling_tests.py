...
class ExceptionHandlingTester:
    ...
    def test_file_permission_errors(self) -> Dict[str, Any]:
        ...
        with patch('builtins.open', side_effect=PermissionError("Permission denied")):
            try:
                permission_result = self.validator.validate_expected_data(expected_dir, actual_dir)
    ...
    def run_all_exception_tests(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # 空期待目录测试
            empty_expected_result = self.test_empty_expected_directory_with_files_in_actual()
