...
class TestExpectedDataSampleLibrary:
    ...
    def test_create_test_scenario(self):
        ...
        # 测试不存在的样本
        nonexistent_scenario = self.library.create_test_scenario("nonexistent_sample", actual_data_dir)
    ...
    def test_export_sample(self):
        ...
        # 测试导出不存在的样本
        nonexistent_export = self.library.export_sample("nonexistent_sample", str(export_dir))
