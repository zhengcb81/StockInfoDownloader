...
class BoundaryValueTester:
    ...
    def test_empty_directories(self) -> ValidationResult:
        ...
        # 执行验证
        return self.validator.validate_expected_data(empty_expected_dir, empty_actual_dir)
    ...
    def test_single_file_scenario(self) -> ValidationResult:
        ...
        # 执行验证
        return self.validator.validate_expected_data(single_expected_dir, single_actual_dir)
    ...
    def test_large_file_scenario(self, file_size_mb: float = 10.0) -> ValidationResult:
        ...
        pdf_footer = b"%%EOF\n"
        large_content = pdf_header + b"x" * int(file_size_mb * 1024 * 1024 - len(pdf_header) - len(pdf_footer)) + pdf_footer  # MB转换为字节
        ...
        # 执行验证
        return self.validator.validate_expected_data(large_expected_dir, large_actual_dir)
    ...
    def test_very_small_file_scenario(self) -> ValidationResult:
        ...
        # 执行验证
        return self.validator.validate_expected_data(small_expected_dir, small_actual_dir)
    ...
    def test_special_characters_filenames(self) -> ValidationResult:
        ...
        # 执行验证
        return self.validator.validate_expected_data(special_expected_dir, special_actual_dir)
    ...
    def test_unicode_filenames(self) -> ValidationResult:
        ...
        # 执行验证
        return self.validator.validate_expected_data(unicode_expected_dir, unicode_actual_dir)
    ...
    def test_file_permission_scenarios(self) -> Dict[str, Any]:
        ...
        # 测试正常文件验证
        normal_result = self.validator.validate_expected_data(perm_expected_dir, perm_actual_dir)
    ...
    def test_comparison_mode_boundaries(self) -> Dict[str, ValidationResult]:
        ...
        for mode in ComparisonMode:
            ...
            result = validator.validate_expected_data(mode_expected_dir, mode_actual_dir)
