...
class ExpectedDataSampleLibrary:
    ...
    def _initialize_samples(self) -> Dict[str, ExpectedDataSample]:
        ...
        return {
            ...
            "partial_sample": ExpectedDataSample(
                ...
                file_sizes={"*一季度报告.pdf": 40 * 1024, "*半年报.pdf": 70 * 1024},
                validation_rules={
                    "required_files": 2,
    ...
    def _create_sample_file(
        self, filepath: Path, stock_name: str, stock_code: str, file_size: int
    ):
        """创建样本文件"""
        # 基础PDF结构
    ...
    def create_test_scenario(
        self, sample_name: str, actual_data_dir: str
    ) -> Dict[str, Any]:
        """创建测试场景"""
    ...
    def export_all_samples(self, export_dir: str) -> str:
        ...
        # 导出样本库配置
        library_config = {"total_samples": len(self.samples), "samples": {}}
