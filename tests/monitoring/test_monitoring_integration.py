...
class TestMonitoringIntegration:
    ...
    def test_monitoring_system_end_to_end(self):
        ...
        performance_check = performance_monitor.check_performance(test_name, performance_metrics)
        assert performance_check is not None

        # 5. 生成报告
        execution_report_path = execution_monitor.save_report("test_execution_report.json")
        performance_report_path = performance_monitor.save_report("test_performance_report.json")
