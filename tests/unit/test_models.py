...
from tests.unit.test_data_manager import (
    get_test_org_id,
    get_test_stock_code,
    get_test_stock_name,
)
...
class TestStockInfo:
    ...
    def test_to_dict(self):
        ...
        stock = StockInfo(stock_code=stock_code, stock_name=stock_name, org_id=org_id)
    ...
    def test_from_dict(self):
        ...
        data = {"stock_code": stock_code, "stock_name": stock_name, "org_id": org_id}
...
class TestOrgIdMapping:
    ...
    def test_valid_mapping(self):
        ...
        mapping = OrgIdMapping(
            stock_code=stock_code, org_id=org_id, stock_name=stock_name
        )
    ...
    def test_stock_code_normalization(self):
        ...
        short_code = stock_code[2:]  # 去掉前两位
        mapping = OrgIdMapping(
            stock_code=short_code, org_id=org_id, stock_name=stock_name
        )
        assert mapping.stock_code == stock_code
...
class TestDownloadTask:
    ...
    def test_custom_target_pages(self):
        ...
        stock_info = StockInfo(stock_code=stock_code, stock_name=stock_name)
        task = DownloadTask(
            task_id="test", stock_info=stock_info, target_pages=["research"]
        )
    ...
    def test_from_dict(self):
        ...
        data = {
            "task_id": "test",
            "stock_info": {"stock_code": stock_code, "stock_name": stock_name},
