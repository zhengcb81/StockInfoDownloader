...
class ReportGenerator:
    ...
    def get_environment_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            env_info["network_status"] = (
                "Connected" if response.status_code == 200 else "Issue"
            )
        except Exception:
    ...
    def create_e2e_report(
        ...
        report_data = {
            ...
            "test_data": {
                ...
                "stock_codes": list(
                    set([case.get("stock_code", "") for case in test_cases])
                ),
    ...
    def create_unit_report(
        self,
        test_results: List[Dict[str, Any]],
        modules_tested: List[str],
        description: str = "单元测试",
    ) -> str:
        """创建单元测试报告"""
    ...
    def create_regression_report(
        ...
        report_data = {
            ...
            "test_environment": self.get_environment_info(),
            "test_data": {"bugs_tested": bugs_tested, "total_tests": len(test_results)},
            "results": test_results,
            "summary": self._calculate_summary(test_results),
        }
    ...
    def create_summary_report(
        self, report_files: List[str], description: str = "综合测试报告"
    ) -> str:
        """创建综合测试报告"""
...
def main():
    ...
    summary_report = generator.create_summary_report(
        report_files=[e2e_report, unit_report], description="示例综合测试报告"
    )
    ...
    comprehensive_report = generator.create_comprehensive_report(
        reports=[e2e_report, unit_report], description="CI/CD综合测试报告"
    )
