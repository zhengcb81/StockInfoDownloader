...
class TestSystemIntegration:
    ...
    def mock_downloader(self, mocker):
        ...
        mocker.patch('src.factory.downloader_factory.downloader_factory.create_downloader', return_value=mock_instance)
    ...
    def test_multiple_stock_processing(self, mock_downloader):
        ...
        mock_downloader.download_stock_pdfs.return_value = DownloadResult(success=True, downloaded_files=["f.pdf"], total_files=1, errors=[], duration_seconds=1, metadata={})
    ...
    def test_performance_metrics(self, mock_downloader):
        ...
        mock_result = DownloadResult(success=True, downloaded_files=[], total_files=0, errors=[], duration_seconds=5.0, metadata={})
        mock_downloader.download_stock_pdfs.return_value = mock_result
        
        downloader = downloader_factory.create_downloader()
        result = downloader.download_stock_pdfs(DownloadRequest(stock_code="1", save_dir="t"))
