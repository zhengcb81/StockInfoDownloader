...
from src.core.exceptions import (
    StockInfoError, WebDriverError, ConfigError, DownloadError, 
    NetworkError, FileSystemError, ValidationError, DataError,
    ErrorCode, ErrorSeverity, RecoveryStrategy, ErrorHandler,
    with_error_handling, error_handler, handle_error
)
from src.core.error_logger import ErrorLogger, ErrorLogEntry, error_logger
from src.core.degradation import (
    NetworkDegradationManager, FileSystemDegradationManager,
    network_degradation_manager, file_system_degradation_manager
)
...
class TestStructuredExceptions(unittest.TestCase):
    ...
    def test_specific_exception_types(self):
        ...
        self.assertEqual(webdriver_error.error_code, ErrorCode.WEBDRIVER_CONNECTION_ERROR)
...
class TestErrorHandler(unittest.TestCase):
    ...
    def test_recovery_handler_registration(self):
        ...
        self.assertEqual(self.handler.recovery_handlers[ErrorCode.SYSTEM_ERROR], custom_recovery)
...
class TestNetworkDegradationManager(unittest.TestCase):
    ...
    def test_fallback_execution(self):
        ...
        result = self.manager.execute_with_fallback(
            failing_operation,
            ['timeout_increase', 'retry_with_backoff'],
            context
        )
