...
from validate_org_id import validate_org_id_url, invalidate_cache, load_validation_config
from orgid_utils import _load_mapping

def validate_all_cached_org_ids(mapping_file: str = None, fix_invalid: bool = True) -> Dict[str, any]:
    """
    验证所有缓存的org ID并修正错误
