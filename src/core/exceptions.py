...
class StockInfoError(Exception):
    ...
    def __init__(
        ...
        self.error_context = ErrorContext(
            ...
            severity=severity,
            message=message,
            module=str(self.caller_info.get("module", "unknown")),
            function=str(self.caller_info.get("function", "unknown")),
            line_number=int(self.caller_info.get("line_number", 0)),
            file_path=str(self.caller_info.get("file_path", "unknown")),
...
class ErrorHandler:
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "modules": modules,
            "recovery_rate": sum(
                1 for ctx in self.error_history if ctx.recovery_successful
            )
